...
export default function JopoModal({ modalTitle, buttonTitle, children }) {
    ...
    <>
      <div>
        <button
          type='button'
          onClick={openModal}
          className='rounded-md bg-blue-700 bg-opacity-75 px-4 py-2 text-sm font-medium text-blue hover:bg-opacity-30 focus:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-opacity-75'
        >
          {buttonTitle}
        </button>
      </div>

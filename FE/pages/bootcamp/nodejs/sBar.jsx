  ...
  return (
    <div className="flex justify-center pb-3">
      <form action="/action_page.php">
        <input
          type="search"
          className="w-fit-content px-3 py-1.5 text-base font-normal text-gray-700 bg-   ite bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none "
          placeholder="Search"
          aria-label="Search"

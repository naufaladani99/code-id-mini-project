...
import { BellIcon, ChevronDownIcon, ChevronRightIcon, MenuIcon, XIcon } from "@heroicons/react/solid"
                    ...
                    <Menu as="div" className="relative">
                      <div>
                        <Menu.Button className="inline-flex w-full items-center justify-center text-base font-medium text-gray-700">
                          Bootcamp Regular <ChevronRightIcon  className="-mr-1 ml-2 h-5 w-5" aria-hidden="true" />
                        </Menu.Button>
                      </div>
                      <Transition
                        as={Fragment}
